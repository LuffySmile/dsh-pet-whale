...
.dshpet-ocean {
  ...
  background:
    radial-gradient(ellipse at 50% -12%, rgba(150,215,255,0.32), rgba(0,0,0,0) 55%),
    linear-gradient(180deg, rgba(30,130,210,0.38), rgba(12,75,170,0.5) 55%, rgba(8,50,140,0.58));
}
...
`;
		...
		const OCEAN_BUBBLES = [
			...
			{ left: '82%', size: 15, dur: 10.5, delay: 0.8 },
