...
.dshpet-ocean {
  ...
  background:
    radial-gradient(ellipse at 50% -12%, rgba(150,215,255,0.22), rgba(0,0,0,0) 55%),
    linear-gradient(180deg, rgba(30,130,210,0.22), rgba(12,75,170,0.3) 55%, rgba(8,50,140,0.36));
}
